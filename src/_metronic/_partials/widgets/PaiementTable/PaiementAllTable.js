...
import { getAllPaiement } from '../../../../api/paiement'

const PaiementAllTable = ({ className }) => {
                  ...
                  return (
                    <tr>
                      ...
                      <td>
                        ...
                        <span className="text-muted d-block font-size-lg">
                      ...
                      <td className="pr-0">
                        <a href="#" className={`btn btn-light-${item.status === 0 ? "success" : "danger"} font-weight-bolder font-size-sm`}>{item.status === 0 ? "Succès" : "Echec"}</a>
                      </td>
                      <td>
                        <span className="text-dark-75 font-weight-bolder d-block font-size-lg">
                          13/04/2022
...
export default PaiementAllTable