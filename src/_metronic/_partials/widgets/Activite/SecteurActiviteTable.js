...
import AddSecteurActivite from './AddSecteurActivite';
import { getSecteurInt } from '../../../../api/activite';

const SecteurActiviteTable = ({className}) => {
  ...
  return (
    <div className={`card card-custom ${className}`}>
      ...
      {/* ********************* Add secteur modal ************************* */}
      <AddSecteurActivite handleClose={handleClose} isDisplayed={show} />
...
export default SecteurActiviteTable