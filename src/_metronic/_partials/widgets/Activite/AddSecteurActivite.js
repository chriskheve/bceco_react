...
import { createSecteurInt } from '../../../../api/activite'
import isEmpty from 'validator/lib/isEmpty'
import alertify from "alertifyjs";
import "../../../../../node_modules/alertifyjs/build/css/alertify.css";
import "../../../../../node_modules/alertifyjs/build/css/themes/semantic.css";

const AddSecteurActivite = ({isDisplayed, handleClose}) => {
    ...
    <div>
        <Modal show={isDisplayed} onHide={handleHide}>
                ...
                <Modal.Header closeButton>
                    <Modal.Title>Ajouter un secteur d'activité</Modal.Title>
                </Modal.Header>
                    <Modal.Body>
                        <div className="row">
...
export default AddSecteurActivite